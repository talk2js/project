...
//            aspect.after(me.menu, 'addChild', lang.hitch(this, function (widget, index) {
//                widget.on('click', lang.hitch(this, function () {
//                    domStyle.set(me.menu.domNode, 'display', 'none');
//                }));
//            }), true);
            if (this.menuItems) {
                for (var i = 0; i < this.menuItems.length; i++) {
                	this.menu.addChild(this.menuItems[i]);
                	this.menuItems[i].on("click", lang.hitch(this, function (e) {
                		this.destroy();
                    }));
                }
            }
