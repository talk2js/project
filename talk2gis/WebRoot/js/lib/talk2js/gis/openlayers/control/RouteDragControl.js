define([
	...
	OpenLayers.Control.RouteDragControl = OpenLayers.Class(OpenLayers.Control, {
	    ...
	    clickFeature: function(feature) {
	    	...
	    	for(i=0, len=points.length; i<len-1; ++i) {
                var prevVertex = points[i];
                var nextVertex = points[i + 1];
                if(prevVertex.CLASS_NAME == "OpenLayers.Geometry.Point" &&
                   nextVertex.CLASS_NAME == "OpenLayers.Geometry.Point") {
                    ...
                    point._index = i + 1;
                    point._virtual = true;
                    virtualFeatures.push(point);
                }
            }
	    	this.layer.addFeatures(virtualFeatures, {silent: true});
    ...
    return OpenLayers.Control.RouteDragControl;
});